...
Simulation createEnzymeDemo() {
  ...
  p['N-b'] = new ParticleType(Colors.blue, 0.01, 0.02);
  p['enzyme'] = new ParticleType(Colors.green, 0.01, 0.05);
  p['enzyme-N'] = new ParticleType(Colors.yellow, 0.01, 0.02);
  p['enzyme-NN'] = new ParticleType(Colors.yellow, 0.01, 0.02);
  ...
  unbindRxn['step 3'] =
      new UnbindReaction(p['enzyme-NN'], [p['enzyme'], p['N-b']], 0.1);
